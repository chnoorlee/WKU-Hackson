...
____exports.CAST = {{
    ...
    task = "把误发解释成正常操作",
    quip = "越出事，越想现场剪个补丁。",
    sprite = "Image/Characters/lin-cheng.png",
    accent = "gold"
}, {
    id = "jiang-ran",
    name = "张开送",
    ...
    task = "让系统和这群人都闭嘴",
    quip = "日志不撒谎，人会抢着替它撒。",
    sprite = "Image/Characters/jiang-ran.png",
    accent = "coral"
}, {
    id = "tang-li",
    name = "寒予水",
    ...
    role = "主持队队长",
    task = "阻止任何人念完那张稿",
    quip = "台上救过无数次场，今晚救不了自己。",
    sprite = "Image/Characters/tang-li.png",
    accent = "gold"
}, {
    id = "zhou-yuan",
    name = "李童牧",
    ...
    role = "活动执行",
    task = "送完物料，再把每句话听明白",
    quip = "什么暗示都接不到，所有东西都接得住。",
    sprite = "Image/Characters/zhou-yuan.png",
    accent = "teal"
}}
____exports.SIGNALS = {{
    id = "wall-screenshot",
...
____exports.EPISODES = {{
    id = "wall-post",
    number = "EP.01",
    title = "撤回以后，置顶了",
    location = "SLAC · 湖景中庭",
    logline = "黄一澈发错帖，张开送按错撤回；寒予水只说了七个字，就从旁观者变成头号嫌疑人。",
    background = "Image/Scenes/slac-interior.png",
    ...
    script = {
        ...
        {kind = "menu", prompt = "评论区开始认领“不要薄荷的人”，用什么挡住？", choices = {{id = "leave-up", text = "顺势办饮料认领，把表白说成开放日互动", effects = {{key = "chaos", amount = 2}, {key = "wit", amount = 1}}, jump = "leave-up"}, {id = "trace", text = "发失物更正，把“第三排”说成雨伞位置", effects = {{key = "order", amount = 2}, {key = "warmth", amount = 1}}, jump = "trace"}}},
    ...
    background = "Image/Scenes/outdoor-lakeside-flowers.png",
    backgroundScale = 0.574,
    path = "chaos",
    script = {
        {kind = "label", name = "start"},
        ...
        {kind = "menu", prompt = "围观者要寒予水解释，她拿什么堵住镜头？", choices = {{id = "tease", text = "借主持人的台，让她宣布这是情侣默契测试", effects = {{key = "chaos", amount = 2}, {key = "wit", amount = 1}}, jump = "tease"}, {id = "ask", text = "让李童牧说清楚，她为什么记得这杯", effects = {{key = "warmth", amount = 2}}, jump = "ask"}}},
    ...
    background = "Image/Scenes/library-interior.png",
    backgroundScale = 0.629,
    path = "order",
    script = {
        {kind = "label", name = "start"},
        ...
        {kind = "menu", prompt = "直播没关，怎么把这张卡从寒予水手里救出来？", choices = {{id = "compare", text = "请寒予水用主持稿示范“正确的失物播报”", effects = {{key = "order", amount = 2}, {key = "wit", amount = 1}}, jump = "compare"}, {id = "wait", text = "让李童牧拿麦，替她说明这只是占座留言", effects = {{key = "warmth", amount = 2}}, jump = "wait"}}},
    ...
    background = "Image/Scenes/outdoor-lake-path.png",
    backgroundScale = 0.574,
    path = "finale",
    script = {
        {kind = "label", name = "start"},
        ...
        {kind = "menu", prompt = "真话已经上麦，最后怎么收掉全校的镜头？", choices = {{id = "give-space", text = "拔掉直播线，把那把黑伞留给他们", effects = {{key = "warmth", amount = 2}}, jump = "resolve"}, {id = "post-fix", text = "让李童牧实名回复，正式认领这条帖子", effects = {{key = "chaos", amount = 1}, {key = "wit", amount = 2}}, jump = "resolve"}}},
        ...
        {kind = "say", speaker = "jiang-ran", text = "她录了。相机红灯还亮着。"},
        {
            ...
            id = "meetup-warm",
            title = "伞找到了，人也是",
            summary = "直播在八点零一分断开。寒予水和李童牧共撑一把伞离开，黄一澈交出存储卡后才被允许跟上。",
            reveal = "写帖：寒予水  ·  误发：黄一澈  ·  收件：李童牧"
        },
        ...
        {kind = "say", speaker = "zhou-yuan", text = "那就不撤。"},
        {
            ...
            id = "meetup-chaos",
            title = "匿名墙完成实名认领",
            summary = "李童牧的实名答复被系统当成失物认领。标题虽然离谱，寒予水没有要求修改。",
            reveal = "写帖：寒予水  ·  误发：黄一澈  ·  收件：李童牧"
        },
        ...
        {kind = "say", speaker = "tang-li", text = "行。附件里的纸星还我。"},
        {
            ...
            id = "meetup-order",
            title = "恋爱关系，按事故归档",
            summary = "张开送补上二次确认流程，也把“双方已答应”写进结案记录。帖子下架了，纸星被寒予水带走。",
            reveal = "写帖：寒予水  ·  误发：黄一澈  ·  收件：李童牧"
        }
    }
}}
